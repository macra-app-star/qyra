...
Just precision tracking with a monochrome design system built for OLED.
...
→ Your macro goals are calculated for you using Mifflin-St Jeor based on your body, activity, and whether you're cutting, maintaining, or bulking

→ Animated progress rings show exactly where you stand in real time

→ All data stays on your device. No analytics. No tracking SDKs.

**Tweet 3:**
Weekly insights show your adherence trends, streak count, and averages at a glance.

Not a dashboard of vanity metrics — actual data about whether you're hitting your targets.

**Tweet 4:**
Apple Health integration pulls your steps and active calories onto your dashboard. No extra setup.

Dark mode native. SwiftData. StoreKit 2. Built entirely in SwiftUI for iOS 17+.

**Tweet 5:**
Built as a solo dev. 42 Swift files. 4,400+ lines of code. Ships with:
...
Track your daily intake with animated progress rings, view weekly adherence trends, and integrate with Apple Health for activity data.

All data is stored on-device. No analytics. No third-party SDKs. No light mode.
...
If you're into the monochrome design aesthetic or you're a fellow SwiftUI dev, I'd love to hear your thoughts.
...
- Smart onboarding: Personalized macro calculation based on body composition + goals
- Monochrome design: Dark mode only, OLED-optimized
